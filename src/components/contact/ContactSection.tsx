        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start lg:gap-20">
          ...
          >
            ...
            <div className="mt-12 border-t border-white/10 pt-7">
              <p className="mb-4 text-xs font-medium uppercase tracking-[0.16em] text-[#E5E2E1]/45">Connect with us</p>
          ...
          <motion.div
            ...
            className="rounded-[20px] border border-[#2A2826] bg-[#171615] p-6 shadow-[0_24px_64px_rgba(0,0,0,0.34),0_8px_24px_rgba(0,0,0,0.2)] sm:p-8 lg:p-10"
          >
            <div className="mb-8 flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#FFB4A8]">Project inquiry</p>
                <h2 className="mt-2 font-hanken text-2xl font-bold tracking-tight text-[#E5E2E1] sm:text-3xl">Send a transmission</h2>
              </div>
              <Mail className="mt-1 h-6 w-6 shrink-0 text-[#FFB4A8]" strokeWidth={1.6} aria-hidden="true" />
            </div>
            ...
            {submitted ? (
              <div className="flex min-h-[360px] flex-col items-center justify-center text-center" role="status" aria-live="polite">
                ...
                <h3 className="mt-6 font-hanken text-2xl font-bold text-[#E5E2E1]">Transmission received.</h3>
                ...
                <button
                  ...
                  className="mt-7 min-h-11 rounded-xl border border-[#3A3735] px-5 text-sm font-semibold text-[#E5E2E1] transition-colors hover:border-[#FF5540] hover:text-[#FF5540] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5540] focus-visible:ring-offset-2 focus-visible:ring-offset-[#171615]"
                >
                  Send another
                </button>
              </div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="h-12 w-full rounded-xl border border-white/10 bg-black/35 px-4 text-sm text-[#E5E2E1] outline-none transition-colors placeholder:text-[#E5E2E1]/30 focus:border-[#FF5540] focus:ring-1 focus:ring-[#FF5540]"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="h-12 w-full appearance-none rounded-xl border border-white/10 bg-black/35 px-4 pr-10 text-sm text-[#E5E2E1] outline-none transition-colors focus:border-[#FF5540] focus:ring-1 focus:ring-[#FF5540]"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="min-h-36 w-full resize-y rounded-xl border border-white/10 bg-black/35 px-4 py-3 text-sm leading-relaxed text-[#E5E2E1] outline-none transition-colors placeholder:text-[#E5E2E1]/30 focus:border-[#FF5540] focus:ring-1 focus:ring-[#FF5540]"
                  />
                </div>

                <button
                  type="submit"
                  className="group mt-2 flex min-h-14 w-full items-center justify-center gap-2 rounded-full bg-[#FF5540] px-5 text-base font-bold text-[#5C0000] shadow-[0_8px_24px_rgba(255,85,64,0.18)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#ff422a] hover:shadow-[0_12px_30px_rgba(255,85,64,0.28)] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFB4A8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#171615]"
                >
                  Send Transmission
